...
public:
	...
	void setAudioOutputPath(const std::string& path);
	...
	/**
	 * @brief Starts recording audio from a default device
	 * @return If the class was already recording  this method returns false, otherwise it returns true;
	*/
	bool recordAudio();
...
private:
	std::string m_FFmpegPath, m_OutputPath, m_AudioOutputPath;
